    ...
    <NavigationMenu className="max-w-full w-full justify-start relative z-50">
      <NavigationMenuList className={`${isMobile ? 'flex-col space-y-2' : 'flex-row'}`}>
        ...
        <NavigationMenuItem className="relative group">
          ...
          <NavigationMenuContent className="data-[motion=from-start]:animate-enter data-[motion=from-end]:animate-enter data-[motion=to-start]:animate-exit data-[motion=to-end]:animate-exit">
